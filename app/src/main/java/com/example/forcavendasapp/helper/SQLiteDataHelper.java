...
public class SQLiteDataHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase sqLiteDatabase) {
        ...
        sqLiteDatabase.execSQL("CREATE TABLE PEDIDOITEM (CODIGO INTEGER PRIMARY KEY AUTOINCREMENT, CODITEM INTEGER, CODPEDIDO INTEGER, QUANTIDADE INTEGER, DESCRICAO VARCHAR(100), FOREIGN KEY (CODITEM) REFERENCES ITEM(CODIGO), FOREIGN KEY (CODPEDIDO) REFERENCES PEDIDO(CODIGO))");
    }
