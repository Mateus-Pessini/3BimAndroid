...
import com.example.forcavendasapp.masks.MaskedCpf;
import com.example.forcavendasapp.masks.MaskedData;
...
public class CadastroCliente extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        MaskedData.addDateMask(editTextDtNasc);
        MaskedCpf.addCPFMask(editTextCpf);
