...
import com.example.forcavendasapp.adapters.ClienteAdapter;
import com.example.forcavendasapp.adapters.EnderecoAdapter;
import com.example.forcavendasapp.adapters.ItemAdapter;
import com.example.forcavendasapp.adapters.PedidoItemAdapter;
...
import com.example.forcavendasapp.controller.PedidoItemController;
...
public class CadastroPedido extends AppCompatActivity {
    ...
    private ArrayList<PedidoItem> listPedidoItem = new ArrayList<>();
    ...
    private PedidoItemController pic = new PedidoItemController(this);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        PedidoItemAdapter PedidoItemadapter = new PedidoItemAdapter(this, listPedidoItem);
        ...
        btnConcluirPedido.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                for(int i = 0; i <= listPedidoItem.size(); i++){
                    listPedidoItem.get(i).setCodigoPedido(pedidoid);
                    pic.salvarPedidoItem(listPedidoItem.get(i));
                }
            ...
            public void onClick(View v) {
                ...
                if (editTextQuantidade.getText().toString().equals("0") || editTextQuantidade.getText().toString().isEmpty()) {
                    ...
                    if (itemJaExiste) {
                        ...
                        listPedidoItem.add(pd);
                        listViewItensPedido.setAdapter(PedidoItemadapter);
                    }
                }
            }
        });
        ...
        btnRemoverItem.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (itemSelecionado != -1) {
                    if (itemSelecionado < PedidoItemadapter.getCount()) {
                        qtdTotal -= PedidoItemadapter.getItem(itemSelecionado).getQuantidade();
                        tvQtd.setText("Total de Itens: " + qtdTotal);
                        PedidoItemadapter.remove(PedidoItemadapter.getItem(itemSelecionado));
